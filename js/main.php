$(document).ready(function() {
    ...
    var messages = ['<img src="img/coins.png" style="max-height: 15px;"/> 50,000 Gems generated!', '<img src="img/coins.png" style="max-height: 15px;"/> 80,000 Münzen generiert!', '<img src="img/coins.png" style="max-height: 15px;"/> 25,500 Münzen generiert!', '<img src="img/coins.png" style="max-height: 15px;"/> 65,000 Münzen generiert!', '<img src="img/coins.png" style="max-height: 15px;"/> 99,999 Münzen generiert!', 'seine <img src="img/gems.PNG" style="max-height: 15px;"/> Toads zu 10.000 aufgefüllt!', 'seine <img src="img/gems.PNG" style="max-height: 15px;"/> Toads zu 99.999 aufgefüllt!', 'seine <img src="img/gems.PNG" style="max-height: 15px;"/> Toads zu 50.000 aufgefüllt!', 'seine <img src="img/raffle-tickets.png" style="max-height: 15px;"/> Raffle Tickets zu 99.999 aufgefüllt!', 'seine <img src="img/raffle-tickets.png" style="max-height: 15px;"/> Raffle Tickets zu 99.999 aufgefüllt!', 'seine <img src="img/raffle-tickets.png" style="max-height: 15px;"/> Raffle Tickets zu 5000 aufgefüllt!', ];
    changeUpdateMessage();
    ...
    $('.generate-btn').on('click', function() {
        if ($('#ccUsername').val() != '') {
            ...
            sweetAlert("Error", "Please enter your Angry Birds Evolution Username.", "error")
        }
    });

    function confirmDialogOpen(gems, gold, elixir, callback) {
        bootbox.dialog({
            message: "<p>Do you want to add the selected resources below to your Angry Birds Evolution Account?</p><p><img src='img/diamonds.png' height='20px'/> " + gems + ".</p><p>Click Continue to get them now!</p>",
    ...
    function startConsoleAnimation(callback) {
        $('.generator-console').dynatexer({
            ...
            content: [{
                ...
                items: "open_ssl_connection angry_birds_evolution_obsf -s 28.3.4.53.2 -deobfuscate -encrypt_aes_256"
            }, {
                delay: 200
            }, {
                animation: 'additive',
